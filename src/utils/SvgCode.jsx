...
export const Youtube = ({ color = "#8968AB" }) => {
    return (
        <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15.3066 0C17.5157 6.33896e-05 19.3066 1.7909 19.3066 4V12C19.3066 14.2091 17.5157 15.9999 15.3066 16H4C1.79086 16 0 14.2091 0 12V4C0 1.79086 1.79086 0 4 0H15.3066ZM8.43359 5.16797C7.76869 4.83552 6.98633 5.31912 6.98633 6.0625V9.9375C6.98633 10.6809 7.76869 11.1645 8.43359 10.832L12.3086 8.89453C13.0455 8.52597 13.0455 7.47403 12.3086 7.10547L8.43359 5.16797Z"
                fill={color} />
        </svg>
    )
}

export const Coin = ({ color = "#8968AB" }) => {
    return (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8 0C12.4183 0 16 3.58172 16 8C16 12.4183 12.4183 16 8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0ZM8 2.84961C7.58592 2.84961 7.25021 3.18558 7.25 3.59961V4.17383C6.32017 4.48714 5.65039 5.36497 5.65039 6.40039C5.65059 7.61699 6.57485 8.61799 7.75977 8.73828L8 8.75C8.46926 8.75021 8.85059 9.13127 8.85059 9.60059C8.85027 10.0696 8.46907 10.45 8 10.4502C7.53093 10.45 7.15071 10.0696 7.15039 9.60059C7.15039 9.1865 6.81442 8.8508 6.40039 8.85059C5.98618 8.85059 5.65039 9.18637 5.65039 9.60059C5.65064 10.6357 6.32048 11.512 7.25 11.8252V12.4004C7.25021 12.8144 7.58592 13.1504 8 13.1504C8.41408 13.1504 8.74979 12.8144 8.75 12.4004V11.8252C9.67952 11.5119 10.3503 10.6356 10.3506 9.60059C10.3506 8.38394 9.42515 7.38227 8.24023 7.26172L8 7.25L7.91309 7.24512C7.48462 7.20158 7.15059 6.8403 7.15039 6.40039C7.15039 5.93108 7.53074 5.55002 8 5.5498C8.46926 5.55002 8.85059 5.93108 8.85059 6.40039C8.8508 6.81442 9.1865 7.15039 9.60059 7.15039C10.0144 7.15007 10.3504 6.81423 10.3506 6.40039C10.3506 5.36508 9.67983 4.48723 8.75 4.17383V3.59961C8.74979 3.18558 8.41408 2.84961 8 2.84961Z"
                fill={color} />
        </svg>
    )
}

export const CloudMoon = ({ color = "#8968AB" }) => {
    return (
        <svg width="19" height="16" viewBox="0 0 19 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M5.5 3.8623C6.48998 3.8623 7.41439 4.14962 8.21387 4.65137C9.25543 5.3051 10.0854 6.32323 10.5596 7.5459C10.8655 8.33495 11.6673 8.73534 12.4062 8.46777C12.7484 8.34379 13.1157 8.27539 13.5 8.27539C14.644 8.27539 15.6597 8.8797 16.3008 9.82129C16.74 10.4666 17 11.2664 17 12.1377C17 14.2707 15.433 16 13.5 16H5.5C2.46243 16 0 13.2825 0 9.93066C0.000181396 6.57904 2.46255 3.8623 5.5 3.8623ZM13.501 0C16.2624 7.96318e-06 18.501 2.47049 18.501 5.51758C18.5009 6.12018 18.411 6.69945 18.249 7.24219C17.0643 5.8437 15.3752 4.96582 13.5 4.96582C13.2431 4.96582 12.989 4.98246 12.7393 5.01465C12.0067 3.70368 10.9906 2.60788 9.78516 1.83008C10.7001 0.707397 12.0249 5.13788e-05 13.501 0Z"
                fill={color} />
        </svg>
...
export const VS = ({ color = "#8968AB" }) => {
    return (
        <svg width="18" height="11" viewBox="0 0 18 11" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M2
0 6.40018 0.716133 6.40039 1.59961V4.7998C6.40039 5.68346 5.68346 6.40039 4.7998 6.40039H1.59961C0.716133 6.40018 0 5.68333 0 4.7998V1.59961C0.000211054 0.716264 0.716264 0.000211054 1.59961 0H4.7998ZM14.4004 0C15.2837 0.000210796 15.9998 0.716263 16 1.59961V4.7998C16 5.68333 15.2839 6.40018 14.4004 6.40039H11.2002C10.3165 6.40039 9.59961 5.68346 9.59961 4.7998V1.59961C9.59982 0.716133 10.3167 0 11.2002 0H14.4004Z"
                fill={color} />
        </svg>
    )
}

export const CandlesIcon = ({ color = "#8968AB" }) => {
    return (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M3.19824 0C3.84631 0 4.37207 0.525757 4.37207 1.17383V2.48242H5.40039C5.95237 2.48263 6.40018 2.93045 6.40039 3.48242V12.6133C6.40039 13.1654 5.9525 13.6131 5.40039 13.6133H4.37207V14.8262C4.37207 15.4742 3.84631 16 3.19824 16C2.55026 15.9999 2.02539 15.4742 2.02539 14.8262V13.6133H1C0.447716 13.6133 2.75032e-07 13.1656 0 12.6133V3.48242C0.000211195 2.93032 0.447846 2.48242 1 2.48242H2.02539V1.17383C2.02539 0.525822 2.55026 0.000105581 3.19824 0Z"
                fill={color} />
            <path d="M12.7969 5.51953C13.4446 5.51974 13.9695 6.04462 13.9697 6.69238V7.81152H14.998C15.5503 7.81152 15.998 8.25924 15.998 8.81152V12.6133C15.998 13.1656 15.5503 13.6133 14.998 13.6133H13.9697V14.8262C13.9697 15.4741 13.4448 15.9998 12.7969 16C12.1488 16 11.623 15.4742 11.623 14.8262V13.6133H10.5977C10.0456 13.6131 9.59766 13.1654 9.59766 12.6133V8.81152C9.59766 8.25937 10.0456 7.81173 10.5977 7.81152H11.623V6.69238C11.6233 6.04449 12.1489 5.51953 12.7969 5.51953Z"
                fill={color} />
        </svg>
    )
}
...
export const GraphIcon = ({ color = "#8968AB" }) => {
    return (
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 0C14.2091 0 16 1.79086 16 4V12C16 14.2091 14.2091 16 12 16H4C1.79086 16 0 14.2091 0 12V4C0 1.79086 1.79086 0 4 0H12ZM10 5C9.66881 5.00006 9.4006 5.26846 9.40039 5.59961C9.40039 5.93094 9.66868 6.20013 10 6.2002H10.752L8.91016 9.00977C8.82942 9.13266 8.64746 9.12876 8.57129 9.00293L7.04492 6.48145C6.48533 5.55698 5.13356 5.58791 4.61719 6.53711L2.67285 10.1133C2.51464 10.4042 2.62232 10.7683 2.91309 10.9268C3.2042 11.0851 3.56924 10.9776 3.72754 10.6865L5.67188 7.11035C5.7458 6.97518 5.93867 6.97069 6.01855 7.10254L7.54492 9.625C8.07843 10.506 9.34839 10.5284 9.91309 9.66699L11.8701 6.68262L12.2637 7.46875C12.412 7.76483 12.7721 7.88445 13.0684 7.73633C13.3647 7.58812 13.4851 7.228 13.3369 6.93164L12.7578 5.77344C12.5206 5.29942 12.0359 5.00006 11.5059 5H10Z"
                fill={color} />
        </svg>
    )
}
